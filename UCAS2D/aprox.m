function [ban_aprox,sub,coor_ap] = aprox(coor,xm,ym,ah,rel)                              % Obtiene angulo total seleccionado 360
%rel = 0.015;                                                                 % La relacion de aproximacion al punto, se puede CALIBRAR
...
ban_aprox = 0;                                                               % Bandera desactivada
